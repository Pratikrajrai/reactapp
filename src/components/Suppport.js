...
import supportImg from '../assets/group.webp'; 
      ...
      <div name="support" className='w-full mt-24'>
          <div className='w-full h-[700px] bg-gray-900/90  absolute'>
            ...
            <div  className='max-w-[1240px] mx-auto text-white relative'>
                ...
                Fugiat asperiores ex reiciendis, ducimus dolorum cupiditate
                 molestiae blanditiis accusantium molestias libero eius laborum 
                 expedita dolor! Dolorem, ipsam. Recusandae!</p>
                 </div>
             ...
             pt-12 sm:pt-20 text-black'>
                 <div className='bg-white rounded-xl shadow-2xl'>
                     <div className='p-8'>
                         <PhoneIcon className='w-16 p-4 bg-indigo-600 text-white rounded-lg 
                         mt-[-4rem]'/>
                         <h3 className='font-bold text-2xl my-6'>Sales</h3>
                         <p className='text-gray-600 text-xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                          Id repellendus expedita voluptatum alias doloremque porro
                           minima explicabo eos impedit ipsam!</p>
                     </div>
                 ...
                 <div className='bg-white rounded-xl shadow-2xl'>
                     <div className='p-8'>
                         <SupportIcon className='w-16 p-4 bg-indigo-600 text-white rounded-lg 
                         mt-[-4rem]'/>
                 ...
                 <div className='bg-white rounded-xl shadow-2xl'>
                     <div className='p-8'>
                         <ChipIcon className='w-16 p-4 bg-indigo-600 text-white rounded-lg 
                         mt-[-4rem]'/>
